...
do
    ...
    echo $batch 
    export MEM_OPT_SWAP=false
    CUDA_VISIBLE_DEVICES=0  python -u imagenet_main.py --batch_size=$batch  --data_dir=/root/dataset/ILSVRC2012/tf_records    --resnet_size=$resnet_size    &> ./result/resnet50-measure-$batch.log  
done